...
<div
	...
	<form class="mb-3" name="myform" id="myform" method="post" action="reviewUpdate.do"  enctype="multipart/form-data">	
			...
			<div class="colorlib-loader"></div>
				...
				<div class="colorlib-product">
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-8 offset-sm-2 text-center colorlib-heading">
								<h2>&nbsp;</h2>
							     ...
							     <select name="prod_id" id="prod_id" style="width: 100px; height:30px;" >
							  		 <option value="2222222">임시임시</option>
							...
							<input type="hidden" name="deleteName" value="${vo.rev_fileName}"/>
				...
				<div class="wrapper">			
					...
					<input type="radio" name="rev_score" value="5" id="rate1" ${vo.rev_score==5?'checked':'' } ><label
						for="rate1">★</label>
					<input type="radio" name="rev_score" value="4" id="rate2" ${vo.rev_score==4?'checked':'' } ><label
						for="rate2">★</label>
					<input type="radio" name="rev_score" value="3" id="rate3" ${vo.rev_score==3?'checked':'' } ><label
						for="rate3">★</label>
					<input type="radio" name="rev_score" value="2" id="rate4" ${vo.rev_score==2?'checked':'' } ><label
						for="rate4">★</label>
					<input type="radio" name="rev_score" value="1" id="rate5" ${vo.rev_score==1?'checked':'' } ><label
						for="rate5">★</label>
		      ...
		      <input type="file" id="imageFile" name="imageFile" accept="image/*" onchange="loadFile(this)">
		       ...
		       <input type="hidden" name="deleteOriginName" value="${vo.rev_originName}"/>
	            <div class="fileContainer">
	                <div class="fileInput">	
	                    <p>FILE NAME:</p>
	                    <p id="fileName">${vo.rev_originName}</p>
	                </div>
				...
				<div>
					...
					cols="40" rows="15">${vo.rev_content }</textarea>
				</div>
				</fieldset>
				</div>
