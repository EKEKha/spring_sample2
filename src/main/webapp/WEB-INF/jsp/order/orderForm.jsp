...
<div class="hero page-inner overlay" style="background-image: url('images/hero_bg_1.jpg')">
     ...
     <div class="section section-properties">
		<div class="container">
			...
			<div class="row">
				...
				<div class="table-wrap" style="padding:40px;">
						  ...
						  <thead class="thead-primary" >
						    ...
						    <tr class="alert" role="alert">
						    	...
						    	<td>
						    		...
						    		<div class="img" style="background-image: url(upload/product/s_${param.prod_image});"></div>
						    		</a>
						    	</td>
						      <td>
						      ...
						      <td class="quantity">
					        	<div class="input-group">
				             	<input type="text" name="quantity" class="quantity form-control input-number" value="${param.o_amount}" min="1" max="100" readonly>
				      ...
				      <td><fmt:formatNumber pattern="###,###,###원" value="${vo.prod_price*param.o_amount}"/></td>
      ...
      <div class="col-lg-8" style="background-color:whitesmoke; padding:40px;">
        	<form method="post" name="od" class="colorlib-form" action="ProductOrder.do">
							<div class="col-md-12">
	...
	<input type="hidden" name="realPrice" value="${sum}"/> 
	...
	<div class="col-md-12">
		...
		<input type="radio" class="radio"  id="aaa" name="pay_kind" value="pay" onclick="setDisplay()" />카카오페이
